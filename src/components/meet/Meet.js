                ...
                <div className="img-1">
                    <div className="top">
                        <div className="img-overlay img-overlay-2">
                            <div className="img-overlay-style">
                                <div className="top-top">
                                    <i className="top" className="fa-brands media-fb fa-facebook"></i>
                                <i className="top" className="fa-brands media-link fa-square-twitter"></i>
                                <i className="top" className="fa-brands media-link fa-instagram"></i>
                                </div>
                            </div>
                        </div>
                        <h6>
